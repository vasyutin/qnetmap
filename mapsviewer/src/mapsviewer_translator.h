...
#ifndef __mapsviewer_translator_h
#define __mapsviewer_translator_h

#include <QObject>

/// Object for translating Maps Viewer text messages. Used to distinguish this
/// app messages from the messages of the other apps.
class MapsViewerTranslator: public QObject {
   Q_OBJECT
   };

#endif // #ifndef __mapsviewer_translator_h