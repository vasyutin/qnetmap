...
#ifndef RASTERMAPPLUGIN_H
#define RASTERMAPPLUGIN_H
...
class TRasterMapPlugin : public TMapPlugin<TRasterMapAdapter> 
{
   Q_OBJECT;
...
public:
   TRasterMapPlugin();
   TRasterMapPlugin(const TRasterMapPlugin& Source_) 
      : TMapPlugin<TRasterMapAdapter>(Source_) { setPlugin(this); }
   virtual ~TRasterMapPlugin() {};
   ...
   QObject* createInstance() { return new TRasterMapPlugin(*this); }
};
